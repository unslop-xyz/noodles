...
- If a function has type "start_point", its name should describe the PURPOSE of the entry point, not just the mechanism. (e.g., "Repo analysis", "Graph export", "User auth").
- Good examples: "Build API response", "Click open button", "Fetch remote config", "Render overview SVG", "Repo analysis"
